...
const init = async (): Promise< void> => {
  ...
  const translateManager = new TranslateManager({ translations: {}, route: Routes[RouteName.AdminApplications] });
  ...
  const menu = new AdminMenu({ userInternal, userFirebase, route: Routes[RouteName.AdminApplications] });
  menu.init();
